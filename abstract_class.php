...
//memanfaatkan class CetakInfoProduk untuk mencetak banyak produk sekaligus
class CetakInfoProduk {
	//untuk menyimpan produk yang akan di cetak sekaligus
	public $daftarProduk = [];

	//untuk menambahkan produk ke dalam array $daftarProduk
	//$produk = Object Type
